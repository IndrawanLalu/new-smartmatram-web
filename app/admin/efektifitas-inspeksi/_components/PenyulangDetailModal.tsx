                ...
                <ResponsiveContainer width="100%" height={180}>
                  <ComposedChart data={chartData} margin={{ top: 5, right: 10, bottom: 0, left: -10 }}>
                    ...
                    <Bar dataKey="gangguan" name="Gangguan" fill="#ef4444" fillOpacity={0.8} radius={[2, 2, 0, 0]}>
                      <LabelList dataKey="gangguan" position="center" style={{ fill: "#fff", fontSize: 10, fontWeight: 700 }} formatter={(v: number) => v > 0 ? v : ""} />
                    </Bar>
                    <Bar dataKey="inspeksi" name="Inspeksi" fill="#34d399" fillOpacity={0.7} radius={[2, 2, 0, 0]}>
                      <LabelList dataKey="inspeksi" position="center" style={{ fill: "#fff", fontSize: 10, fontWeight: 700 }} formatter={(v: number) => v > 0 ? v : ""} />
                    </Bar>
                    <Bar dataKey="eksekusi" name="Eksekusi" fill="#6366f1" fillOpacity={0.8} radius={[2, 2, 0, 0]}>
                      <LabelList dataKey="eksekusi" position="center" style={{ fill: "#fff", fontSize: 10, fontWeight: 700 }} formatter={(v: number) => v > 0 ? v : ""} />
                    </Bar>
                    {selesaiLabel && (
                      <ReferenceLine
                        x={selesaiLabel}
