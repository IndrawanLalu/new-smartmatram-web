...
| Fase | Isi | Butuh |
|---|---|---|
| **1** | SQL: `segmen.panjang_manual_km` + view panjang yang memilih hitungan-atau-ketikan | SQL Editor |
| **2** | Web: Master Segmen + impor segmen per penyulang (`rencana-master-data.md`) | deploy web |
